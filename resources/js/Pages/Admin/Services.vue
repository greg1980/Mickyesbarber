              ...
              <tr v-for="service in services.data" :key="service.id">
                ...
                <td class="px-4 py-3 whitespace-nowrap flex space-x-2">
                  ...
                  <button
                    ...
                    :class="service.is_active ? 'bg-orange-500 hover:bg-orange-600' : 'bg-green-500 hover:bg-green-600'"
                    class="text-white px-2 py-1 rounded"
                    :title="service.is_active ? 'Deactivate' : 'Activate'"
                  >
                    <svg v-if="service.is_active" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
